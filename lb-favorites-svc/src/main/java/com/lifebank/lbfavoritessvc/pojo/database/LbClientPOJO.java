...
public class LbClientPOJO {
    ...
    private Collection<LbFavoritesPOJO> lbFavoritesByCliId;
    ...
    @OneToMany(mappedBy = "lbClientByFavCliId")
    public Collection<LbFavoritesPOJO> getLbFavoritesByCliId() {
        return lbFavoritesByCliId;
    }

    public void setLbFavoritesByCliId(Collection<LbFavoritesPOJO> lbFavoritesByCliId) {
        this.lbFavoritesByCliId = lbFavoritesByCliId;
    }
