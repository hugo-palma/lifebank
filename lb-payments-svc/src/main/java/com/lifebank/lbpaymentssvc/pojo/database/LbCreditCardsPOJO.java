...
public class LbCreditCardsPOJO {
    ...
    private Collection<LbAccountCreditcardPaymentsPOJO> lbAccountCreditcardPaymentsByCreId;
    private Collection<LbCardPaymentsPOJO> lbCardPaymentsByCreId;
    ...
    @OneToMany(mappedBy = "lbCreditCardsByAcpCreId")
    public Collection<LbAccountCreditcardPaymentsPOJO> getLbAccountCreditcardPaymentsByCreId() {
        return lbAccountCreditcardPaymentsByCreId;
    }

    public void setLbAccountCreditcardPaymentsByCreId(Collection<LbAccountCreditcardPaymentsPOJO> lbAccountCreditcardPaymentsByCreId) {
        this.lbAccountCreditcardPaymentsByCreId = lbAccountCreditcardPaymentsByCreId;
    }

    @OneToMany(mappedBy = "lbCreditCardsByCpaCreId")
    public Collection<LbCardPaymentsPOJO> getLbCardPaymentsByCreId() {
        return lbCardPaymentsByCreId;
    }

    public void setLbCardPaymentsByCreId(Collection<LbCardPaymentsPOJO> lbCardPaymentsByCreId) {
        this.lbCardPaymentsByCreId = lbCardPaymentsByCreId;
    }
