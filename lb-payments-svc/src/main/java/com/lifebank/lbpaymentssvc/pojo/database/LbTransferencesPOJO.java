...
public class LbTransferencesPOJO {
    ...
    @ManyToOne
    @JoinColumn(name = "tra_emitter_account", referencedColumnName = "acc_id", nullable = false, insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "tra_receiver_account", referencedColumnName = "acc_id", nullable = false, insertable = false, updatable = false)
    ...
    @ManyToOne
    @JoinColumn(name = "tra_dtr_id", referencedColumnName = "dtr_id", nullable = false, insertable = false, updatable = false)
